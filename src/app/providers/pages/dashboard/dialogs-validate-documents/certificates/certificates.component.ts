...
import { CertificatesValidateDocumentsService } from 'src/app/providers/services/validate-documents/certificates-validate-documents.service';
@Component({
...
export class CertificatesComponent {
  ...
  ngOnInit(): void {
    ...
    this.validateDocuments$ = this.certificatesValidateDocumentsService
    ...
    try {
      this.subscription.add(
        this.certificatesValidateDocumentsService
          .addValidateDocumentsCertificates(this.archive.value)
  ...
  async delete(index: number, item?: ValidateDocumentsModel) {
    ...
    try {
      this.subscription.add(
        this.certificatesValidateDocumentsService
          .deleteValidateDocumentsCertificates(id)
          .subscribe((batch) => {
            if (batch) {
              batch
                .commit()
