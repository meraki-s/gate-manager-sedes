...
import { ChecklistValidateDocumentsService } from 'src/app/providers/services/validate-documents/checklist-validate-documents.service';
@Component({
...
export class ChecklistComponent {
  ...
  ngOnInit(): void {
    ...
    this.validateDocuments$ = this.checklistValidateDocumentsService
    ...
    try {
      this.subscription.add(
        this.checklistValidateDocumentsService
          .addValidateDocumentsChecklist(this.archive.value)
  ...
  async delete(index: number, item?: ValidateDocumentsModel) {
    ...
    try {
      this.subscription.add(
        this.checklistValidateDocumentsService
          .deleteValidateDocumentsChecklist(id)
          .subscribe((batch) => {
            if (batch) {
              batch
                .commit()
