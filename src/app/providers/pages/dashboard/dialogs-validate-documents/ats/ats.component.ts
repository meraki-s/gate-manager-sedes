...
import { AtsValidateDocumentsService } from 'src/app/providers/services/validate-documents/ats-validate-documents.service';
...
export class AtsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.subscription.add(
      this.authService.user$.subscribe((user) => {
        this.pathStorage = `providers/${this.user?.uid}/ats-pdf/`;
      })
    );
